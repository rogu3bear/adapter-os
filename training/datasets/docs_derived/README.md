...
**Purpose:** Train adapters on canonical AdapterOS patterns from CLAUDE.md and architecture docs
...
- **CLAUDE.md:** Canonical developer reference
...
```jsonl
{
  "input": {
    ...
    "doc_source": "CLAUDE.md#error-handling"
  },
  "target": {
...
- **Min Relevance:** 0.90
- **Min Confidence:** 0.90
- **Doc Coverage:** >70% of CLAUDE.md sections
...
cat CLAUDE.md | extract_code_blocks > patterns.jsonl

# 2. Validate against codebase
cargo test --doc

# 3. Quality check
check_doc_coverage CLAUDE.md crates/
