...
- **Source:** CLAUDE.md (AdapterOS Developer Guide)
...
**Description:**
Question-answer pairs generated from CLAUDE.md for instruction tuning. Teaches adapters to answer questions about AdapterOS architecture, conventions, and best practices.
...
// Ingest CLAUDE.md
let document = ingestor.ingest_markdown_path("CLAUDE.md")?;
...
let request = CreateDatasetRequest {
    ...
    description: Some("Identity mapping from CLAUDE.md".to_string()),
...
These datasets demonstrate the 5-step training pipeline from CLAUDE.md:

1. **Ingest** → `DocumentIngestor::ingest_markdown_path("CLAUDE.md")`
...
- **Developer Guide:** `CLAUDE.md` (source document)
