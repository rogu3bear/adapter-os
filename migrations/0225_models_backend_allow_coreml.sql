-- Allow CoreML backend in models.backend CHECK constraint while preserving existing data
...
CREATE TABLE models_new (
    ...
    adapter_path TEXT,
    backend TEXT NOT NULL DEFAULT 'metal' CHECK(backend IN ('metal', 'mlx-ffi', 'mlx', 'coreml')),
    quantization TEXT,
    last_error TEXT,
    size_bytes INTEGER,
    format TEXT,
