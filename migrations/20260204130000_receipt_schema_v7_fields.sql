...
-- Purpose: Add receipt V7 fields for determinism envelope and cache/retrieval bindings

ALTER TABLE inference_trace_receipts ADD COLUMN tokenizer_hash_b3 BLOB;
...
ALTER TABLE inference_trace_receipts ADD COLUMN model_build_hash_b3 BLOB;
ALTER TABLE inference_trace_receipts ADD COLUMN adapter_build_hash_b3 BLOB;
...
ALTER TABLE inference_trace_receipts ADD COLUMN seed_digest_b3 BLOB;
...
ALTER TABLE inference_trace_receipts ADD COLUMN stop_window_digest_b3 BLOB;
ALTER TABLE inference_trace_receipts ADD COLUMN cache_scope TEXT;
ALTER TABLE inference_trace_receipts ADD COLUMN cached_prefix_digest_b3 BLOB;
ALTER TABLE inference_trace_receipts ADD COLUMN cached_prefix_len INTEGER;
ALTER TABLE inference_trace_receipts ADD COLUMN cache_key_b3 BLOB;
ALTER TABLE inference_trace_receipts ADD COLUMN retrieval_merkle_root_b3 BLOB;
ALTER TABLE inference_trace_receipts ADD COLUMN retrieval_order_digest_b3 BLOB;
ALTER TABLE inference_trace_receipts ADD COLUMN tool_call_inputs_digest_b3 BLOB;
ALTER TABLE inference_trace_receipts ADD COLUMN tool_call_outputs_digest_b3 BLOB;
