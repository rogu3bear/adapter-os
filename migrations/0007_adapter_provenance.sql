...
CREATE TABLE IF NOT EXISTS replication_journal (
    ...
    bytes INTEGER NOT NULL DEFAULT 0,   -- Total bytes transferred
...
CREATE TABLE IF NOT EXISTS replication_artifacts (
    ...
    transferred_at TEXT,                -- NULL if not yet transferred
    verified BOOLEAN NOT NULL DEFAULT 0, -- Hash verification status
