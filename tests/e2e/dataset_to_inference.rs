...
mod tests {
    ...
    #[tokio::test]
    #[ignore = "E2E test requires full system setup - run with: cargo test --release -- --ignored [tracking: STAB-IGN-0170]"]
    ...
    #[tokio::test]
    #[ignore = "E2E test requires full system setup - run with: cargo test --release -- --ignored [tracking: STAB-IGN-0171]"]
