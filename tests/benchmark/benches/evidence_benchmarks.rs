    ...
    rt.block_on(async {
        ...
        c.bench_function("evidence_ranking_1000_items", |b| {
            b.iter(|| {
                ...
                evidence_items.sort_by(|a, b| b.1.partial_cmp(&a.1).unwrap_or(std::cmp::Ordering::Equal));
    ...
    rt.block_on(async {
        ...
        c.bench_function("evidence_quality_assessment", |b| {
            b.iter(|| {
                ...
                // Sort by quality
                quality_scores.sort_by(|a, b| b.1.partial_cmp(&a.1).unwrap_or(std::cmp::Ordering::Equal));
            ...
            b.iter_custom(|iters| {
                ...
                for _ in 0..iters {
                    async fn process_with_evidence() -> Duration {
                        ...
                        evidence_scores.sort_by(|a, b| b.partial_cmp(a).unwrap_or(std::cmp::Ordering::Equal));
        ...
        c.bench_function("evidence_processing_pipeline_latency", |b| {
            b.iter_custom(|iters| {
                ...
                for _ in 0..iters {
                    ...
                    scored_evidence.sort_by(|a, b| b.1.partial_cmp(&a.1).unwrap_or(std::cmp::Ordering::Equal));
