...
| `GET` | `/v1/stream/adapters` | `handlers::adapter_state_stream` | `UNKNOWN` |
| `GET` | `/v1/stream/boot-progress` | `handlers::boot_progress::boot_progress_stream` | `UNKNOWN` |
| `GET` | `/v1/stream/messages/{workspace_id}` | `handlers::streaming::messages_stream` | `UNKNOWN` |
| `GET` | `/v1/stream/metrics` | `handlers::system_metrics_stream` | `UNKNOWN` |
| `GET` | `/v1/stream/notifications` | `handlers::streaming::notifications_stream` | `UNKNOWN` |
| `GET` | `/v1/stream/stack-policies/{id}` | `handlers::stack_policy_stream` | `UNKNOWN` |
| `GET` | `/v1/stream/telemetry` | `handlers::telemetry_events_stream` | `UNKNOWN` |
...
| `GET` | `/v1/streams/training` | `handlers::streaming::activity_stream` | `UNKNOWN` |
