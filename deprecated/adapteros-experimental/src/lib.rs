...
impl ExperimentalRegistry {
    ...
    fn register_features(&mut self) {
        ...
        self.register_feature(ExperimentalFeature {
            ...
            dependencies: vec![
                "adapteros-cli".to_string(),
                "adapteros-single-file-adapter".to_string(),
            ],
            last_updated: "2025-01-15".to_string(),
            known_issues: vec![],
            description: "AOS CLI commands with complete implementations".to_string(),
        });
        ...
        self.register_feature(ExperimentalFeature {
            ...
            last_updated: "2025-01-15".to_string(),
            known_issues: vec![],
            description: "Error recovery with complete retry logic and statistics".to_string(),
        });
...
mod tests {
    ...
    fn test_experimental_registry() {
        ...
        assert!(matches!(aos_cli.status, FeatureStatus::Completed));
        assert!(matches!(aos_cli.stability, StabilityLevel::Stable));
