...
//!
//! **Caveat**: If two cache entries have equal match lengths during longest-prefix
//! search, the first encountered wins. HashMap iteration order is deterministic
//! for identical insertion patterns within a process, but may vary across restarts.
//! For strict determinism, ensure cache entries have unique prefix lengths.
//!
