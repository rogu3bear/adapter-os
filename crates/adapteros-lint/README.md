...
**Acceptable:**
- Read-only SELECT queries (per CLAUDE.md)
...
- Read-only SELECT queries are always acceptable (per CLAUDE.md)
...
- [CLAUDE.md](../../CLAUDE.md) - Architectural patterns and standards
