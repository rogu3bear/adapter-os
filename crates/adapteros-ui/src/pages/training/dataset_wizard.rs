...
/// Unified outcome for any dataset acquisition (upload or generation).
#[derive(Clone, Debug, PartialEq)]
pub struct DatasetOutcome {
    pub dataset_id: String,
    pub dataset_version_id: Option<String>,
    pub sample_count: usize,
    /// Synthetic datasets were generated by local inference, not uploaded.
    pub is_synthetic: bool,
    /// BLAKE3 hash — of the dataset for uploads, of the source model for generation.
    pub source_hash: Option<String>,
    /// Number of generation receipts (0 for uploads).
...
pub fn DatasetUploadWizard(
    open: RwSignal<bool>,
    on_complete: Callback<DatasetOutcome>,
) -> impl IntoView {
