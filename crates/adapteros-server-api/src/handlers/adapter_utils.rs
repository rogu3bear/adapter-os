...
pub fn parse_hash_b3(hash_b3: &str) -> Result<B3Hash, String> {
...
pub fn guard_in_flight_requests(
...
pub fn lora_tier_from_provenance(provenance_json: &Option<String>) -> Option<LoraTier> {
    provenance_json
        .as_ref()
...
pub fn lora_scope_from_provenance(
...
pub fn compute_serveable_state(release_state: &str, trust_state: &str) -> (bool, Option<String>) {
...
pub async fn manifest_lineage_from_aos(
    aos_path: Option<&str>,
