...
struct ReceiptRow {
    ...
    tokenizer_hash_b3: Option<Vec<u8>>,
    tokenizer_version: Option<String>,
    tokenizer_normalization: Option<String>,
    model_build_hash_b3: Option<Vec<u8>>,
    adapter_build_hash_b3: Option<Vec<u8>>,
    decode_algo: Option<String>,
    temperature_q15: Option<i64>,
    top_p_q15: Option<i64>,
    top_k: Option<i64>,
    seed_digest_b3: Option<Vec<u8>>,
    sampling_backend: Option<String>,
    thread_count: Option<i64>,
    reduction_strategy: Option<String>,
    stop_eos_q15: Option<i64>,
    stop_window_digest_b3: Option<Vec<u8>>,
    cache_scope: Option<String>,
    cached_prefix_digest_b3: Option<Vec<u8>>,
    cached_prefix_len: Option<i64>,
    cache_key_b3: Option<Vec<u8>>,
    retrieval_merkle_root_b3: Option<Vec<u8>>,
    retrieval_order_digest_b3: Option<Vec<u8>>,
    tool_call_inputs_digest_b3: Option<Vec<u8>>,
    tool_call_outputs_digest_b3: Option<Vec<u8>>,
...
pub async fn get_receipt_by_digest(
    ...
    let row = sqlx::query_as::<_, ReceiptRow>(
        ...
        SELECT
            ...
            r.tokenizer_hash_b3,
            r.tokenizer_version,
            r.tokenizer_normalization,
            r.model_build_hash_b3,
            r.adapter_build_hash_b3,
            r.decode_algo,
            r.temperature_q15,
            r.top_p_q15,
            r.top_k,
            ...
            r.stop_eos_q15,
            r.stop_window_digest_b3,
            r.cache_scope,
            r.cached_prefix_digest_b3,
            r.cached_prefix_len,
            r.cache_key_b3,
            r.retrieval_merkle_root_b3,
            r.retrieval_order_digest_b3,
            r.tool_call_inputs_digest_b3,
            r.tool_call_outputs_digest_b3,
            r.disclosure_level,
            r.receipt_signing_kid,
            r.receipt_signed_at
    ...
    let run_receipt = RunReceipt {
        ...
        tokenizer_hash_b3: parse_digest_opt("tokenizer_hash_b3", row.tokenizer_hash_b3)?,
        ...
        top_k: row.top_k.map(|v| v.max(0) as u32),
        seed_digest_b3: parse_digest_opt("seed_digest_b3", row.seed_digest_b3)?,
        ...
        cached_prefix_digest_b3: parse_digest_opt(
            ...
            row.cached_prefix_digest_b3,
        )?,
        cached_prefix_len: row.cached_prefix_len.map(|v| v.max(0) as u32),
        cache_key_b3: parse_digest_opt("cache_key_b3", row.cache_key_b3)?,
        retrieval_merkle_root_b3: parse_digest_opt(
            "retrieval_merkle_root_b3",
            row.retrieval_merkle_root_b3,
        )?,
        retrieval_order_digest_b3: parse_digest_opt(
            "retrieval_order_digest_b3",
            row.retrieval_order_digest_b3,
        )?,
        tool_call_inputs_digest_b3: parse_digest_opt(
            "tool_call_inputs_digest_b3",
            row.tool_call_inputs_digest_b3,
        )?,
        tool_call_outputs_digest_b3: parse_digest_opt(
            "tool_call_outputs_digest_b3",
            row.tool_call_outputs_digest_b3,
        )?,
        disclosure_level: row.disclosure_level,
        receipt_signing_kid: row.receipt_signing_kid,
        receipt_signed_at: row.receipt_signed_at,
    };
