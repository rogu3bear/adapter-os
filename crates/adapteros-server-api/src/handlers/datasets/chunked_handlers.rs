...
use super::types::{
    CompleteChunkedUploadRequest, CompleteChunkedUploadResponse, UploadChunkQuery,
    UploadChunkResponse, UploadSessionStatusResponse,
};
...
pub async fn complete_chunked_upload(
    ...
    if !is_complete {
        let expected_chunks = session.total_size.div_ceil(session.chunk_size as u64) as usize;
