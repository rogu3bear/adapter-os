...
pub use adapter_health::{get_adapter_activations, get_adapter_health, verify_gpu_integrity};
...
pub mod adapters_lifecycle {
    ...
    pub use super::adapters::{delete_adapter, register_adapter};
}
...
pub use infrastructure::{
    evict_node, get_base_model_status, get_node_details, list_jobs, list_nodes,
    mark_node_offline, register_node, test_node_connection,
};

// Re-export discovery handlers (contacts & discovery streams)
pub use discovery::{
    contacts_stream, create_contact, delete_contact, discovery_stream, get_contact,
    get_contact_interactions, list_contacts,
};
