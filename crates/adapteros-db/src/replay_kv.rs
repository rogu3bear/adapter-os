...
impl Db {
    ...
    pub(crate) fn kv_replay_metadata_from_params(
        ...
        ReplayMetadataKv {
            ...
            coreml_expected_package_hash: params.coreml_expected_package_hash.clone(),
            coreml_hash_mismatch: params.coreml_hash_mismatch,
            ...
            coreml_compute_preference: params.coreml_compute_preference.clone(),
            coreml_compute_units: params.coreml_compute_units.clone(),
            coreml_gpu_used: params.coreml_gpu_used,
            fallback_backend: params.fallback_backend.clone(),
    ...
    pub(crate) fn kv_replay_metadata_to_record(
        ...
        Ok(InferenceReplayMetadata {
            ...
            coreml_package_hash: meta.coreml_package_hash,
            coreml_expected_package_hash: meta.coreml_expected_package_hash,
            ...
            coreml_compute_preference: meta.coreml_compute_preference,
            coreml_compute_units: meta.coreml_compute_units,
            coreml_gpu_used: meta.coreml_gpu_used,
            fallback_backend: meta.fallback_backend,
