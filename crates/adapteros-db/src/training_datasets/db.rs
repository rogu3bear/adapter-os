...
use crate::Db;
use crate::training_datasets::types::*;
...
use crate::training_datasets::validation::{validate_hash_b3, validate_format, validate_status, validate_category};
use crate::training_datasets::trust::{derive_overall_safety_status, derive_trust_state};
...
// Helper functions extracted from mod.rs
...
fn build_training_rows_from_jsonl_bytes(
    file_name: &str,
    data: &[u8],
    dataset_id: &str,
    dataset_version_id: &str,
...
fn build_codebase_rows_from_jsonl_bytes(
    _file_name: &str,
    data: &[u8],
