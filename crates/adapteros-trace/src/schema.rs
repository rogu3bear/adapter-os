...
/// Record type for trace bundle headers in NDJSON streams
pub const TRACE_BUNDLE_HEADER_RECORD: &str = "bundle_header";

/// Bundle header record for NDJSON trace files
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct TraceBundleHeader {
...
impl TraceBundleHeader {
    pub fn from_bundle(bundle: &TraceBundle) -> Self {
        Self {
            record_type: TRACE_BUNDLE_HEADER_RECORD.to_string(),
            bundle_id: bundle.bundle_id,
            version: bundle.version,
            global_seed: bundle.global_seed,
    ...
    pub fn is_header(&self) -> bool {
        self.record_type == TRACE_BUNDLE_HEADER_RECORD
    }
}
