...
impl schemars::JsonSchema for B3Hash {
    ...
    fn json_schema(gen: &mut schemars::gen::SchemaGenerator) -> schemars::schema::Schema {
        ...
        schema.metadata().description = Some("BLAKE3 hash (hex encoded, 32 bytes)".to_string());
        schema.format = Some("hex".to_string());
...
impl utoipa::PartialSchema for B3Hash {
    fn schema() -> utoipa::openapi::RefOr<utoipa::openapi::schema::Schema> {
        utoipa::openapi::ObjectBuilder::new()
            ...
            .description(Some("BLAKE3 hash (64 hex characters)".to_string()))
