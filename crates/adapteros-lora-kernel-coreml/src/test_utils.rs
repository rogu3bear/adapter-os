//! Shared test utilities for CoreML backend tests
//!
//! This module provides reusable utilities for testing the CoreML backend including:
//! - Mock adapter creation
//! - Deterministic weight generation (seeded LCG)
