...
pub enum EventType {
    ...
    // Plugin events (PRD 7 - Operator / Plugin Isolation)
    PluginLoaded,
    PluginStarted,
    PluginStopped,
    PluginHealthCheckStart,
    PluginHealthCheckComplete,
    PluginHealthFailed,
    PluginDegraded,
    PluginRecovered,
    PluginRestartAttempt,
    PluginRestartSuccess,
    PluginRestartFailed,
    PluginRestartLimitReached,
    PluginCircuitBreakerOpened,
    PluginCircuitBreakerClosed,
    PluginCircuitBreakerHalfOpen,
    PluginQuiesced,
    PluginTimeout,
...
impl EventType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            EventType::PluginHealthCheckStart => "plugin.health_check.start",
            EventType::PluginHealthCheckComplete => "plugin.health_check.complete",
            EventType::PluginHealthFailed => "plugin.health_failed",
            EventType::PluginDegraded => "plugin.degraded",
            EventType::PluginRecovered => "plugin.recovered",
            EventType::PluginRestartAttempt => "plugin.restart.attempt",
            EventType::PluginRestartSuccess => "plugin.restart.success",
            EventType::PluginRestartFailed => "plugin.restart.failed",
            EventType::PluginRestartLimitReached => "plugin.restart.limit_reached",
            EventType::PluginCircuitBreakerOpened => "plugin.circuit_breaker.opened",
            EventType::PluginCircuitBreakerClosed => "plugin.circuit_breaker.closed",
            EventType::PluginCircuitBreakerHalfOpen => "plugin.circuit_breaker.half_open",
            EventType::PluginQuiesced => "plugin.quiesced",
