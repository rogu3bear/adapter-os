...
// Use TelemetryWriter from parent telemetry crate
use crate::TelemetryWriter;
...
// Define locally-scoped types to avoid conflicts with parent telemetry metrics
pub use self::metrics::{AdapterMetrics as ProfilerMetrics, MetricsAggregator};
pub use self::scoring::{rank_adapters, AdapterScorer};

/// Profiler-specific aggregate metrics type
pub type ProfilerAdapterMetrics = self::metrics::AdapterMetrics;

// Re-export for module use
use self::metrics::AdapterMetrics;
use parking_lot::RwLock;

/// Profiler scope for performance tracking
