...
Helper function to create temporary directories under `var/tmp` for test isolation. This ensures tests comply with the path security requirements (no `/tmp` or `/private/tmp`).
