...
//!
//! Provides REST endpoints for admin-only user management operations.
//!
...
pub async fn list_users<S: AdminAppState>(
    State(state): State<S>,
    Extension(claims): Extension<AdminClaims>,
    Query(params): Query<ListUsersParams>,
) -> Result<Json<ListUsersResponse>, (StatusCode, Json<AdminErrorResponse>)> {
    // Require Admin role
