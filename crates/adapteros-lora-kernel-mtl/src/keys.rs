...
pub const TEST_KEY_SEED: [u8; 32] = [
    0x7a, 0x8b, 0x9c, 0xad, 0xbe, 0xcf, 0xd0, 0xe1, 0xf2, 0x03, 0x14, 0x25, 0x36, 0x47, 0x58, 0x69,
    0x7a, 0x8b, 0x9c, 0xad, 0xbe, 0xcf, 0xd0, 0xe1, 0xf2, 0x03, 0x14, 0x25, 0x36, 0x47, 0x58, 0x69,
];
...
mod tests {
    ...
    fn test_signing_key_matches_public_key() {
        ...
        let verifying_key = VerifyingKey::from_bytes(&public_key_bytes).expect("Valid public key");
        assert!(
