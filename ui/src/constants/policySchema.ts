  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        description: 'Clusters the router may target; empty = allow all',
        required: false,
        default: [],
      },
      {
        name: 'denied_clusters',
        type: 'array',
        label: 'Denied Clusters',
        description: 'Clusters the router must never target',
        required: false,
        default: [],
      },
      {
        name: 'max_reasoning_depth',
        type: 'number',
        label: 'Max Reasoning Depth',
        description: 'Maximum number of cluster swaps/hops before fallback',
        required: false,
        default: 10,
        min: 0,
      },
      {
        ...
        type: 'enum',
        label: 'Cluster Fallback',
        description: 'Behavior when a transition is blocked',
        required: false,
        default: 'stay_on_current',
        options: ['stay_on_current', 'fallback_to_base'],
      },
    ],
  },
  {
