...
function Sidebar({
  ...
  if (collapsible === "none") {
    // Static sidebar - no fixed positioning, proper flexbox child
    return (
      <aside
        className={cn(
  ...
  // Collapsible sidebar - static flex child with width transition
  return (
    <aside
      className={cn(
...
function SidebarInset({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "bg-background flex min-w-0 flex-1 flex-col overflow-y-auto",
        className,
      )}
      {...props}
    />
...
function SidebarGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="group"
      className={cn("relative flex w-full min-w-0 flex-col px-1 py-1.5", className)}
      {...props}
    />
  );
}
