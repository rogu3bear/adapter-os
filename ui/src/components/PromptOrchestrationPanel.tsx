...
// [source: AGENTS.md - Policy Pack #9 (Telemetry)]
...
// [source: AGENTS.md - Policy Pack #1 (Egress) - use local state when backend unavailable]
...
function analyzePromptLocally(prompt: string): PromptAnalysisResult {
  ...
  // [source: AGENTS.md - K-Sparse Routing concept]
