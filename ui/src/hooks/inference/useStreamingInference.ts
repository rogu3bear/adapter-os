...
import type { InferResponse, InferenceTrace, InferenceConfig, StreamingChunk, Citation, StreamingInferRequest } from '@/api/types';
        ...
        requestData,
        {
          ...
          onComplete: (
            ...
            const finalResponse: InferResponse = {
              ...
              trace: { // Minimal trace for streaming - missing some fields
                adapters_used: adapterId && adapterId !== 'none' ? [adapterId] : [],
                latency_ms: elapsed,
                router_decisions: [], // Streaming doesn't provide router decisions
              }
            };
