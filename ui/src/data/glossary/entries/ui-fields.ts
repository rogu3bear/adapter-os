...
export const uiFieldsEntries: GlossaryEntry[] = [
  ...
  },
  {
    ...
    content: {
      ...
      detailed: 'Settings section for configuring system parameters, managing users, workspaces, policies, and administrative functions.',
    },
  ...
  {
    id: 'active-tenants',
    term: 'Active Workspaces',
    category: 'ui-fields',
    content: {
      brief: 'Isolated workspace environments with their own adapters and policies.',
      detailed: 'Number of workspace environments currently in Active state. Each workspace has isolated resources, dedicated adapters, and independent policy enforcement.',
    },
    relatedTerms: ['tenant-name', 'tenant-status', 'tenant-isolation'],
    aliases: ['workspaces', 'workspace count'],
  },
  ...
  },
  {
    ...
    category: 'ui-fields',
    content: {
      brief: 'Search across event type, user ID, workspace ID, component, trace ID, and metadata fields.',
      detailed: 'Full-text search:\n- Searches: event type, user, workspace, component, trace_id\n- Also searches JSON metadata fields\n- Case-insensitive\n- Supports partial matches\n- Combined with filters (AND logic)',
    },
  ...
  },
  {
    ...
    category: 'ui-fields',
    content: {
      brief: 'Frequently used operations for managing workspaces, adapters, and system health.',
      detailed: 'Shortcut actions:\n- One-click access to common tasks\n- Respects RBAC permissions\n- Includes: create workspace, deploy adapter, view health\n- Customizable per user role',
    },
  ...
  },
  {
    ...
    term: 'Quick Action: Create Workspace',
    category: 'ui-fields',
    content: {
      brief: 'Create a new isolated workspace environment with dedicated adapters and policies.',
      detailed: 'Workspace creation shortcut:\n- Opens create workspace modal\n- Requires workspace management permission\n- Prompts for: name, isolation level, UID/GID\n- Auto-initializes workspace registry',
    },
  ...
  // ===== Dashboard Modal Form Fields =====
  {
    ...
    term: 'Workspace Name Field',
    category: 'ui-fields',
    content: {
      brief: 'Unique identifier for the workspace. Use lowercase letters, numbers, and hyphens only.',
      detailed: 'Workspace name input:\n- Format: lowercase, alphanumeric, hyphens\n- Must be unique across system\n- Used in URLs and API paths\n- Cannot be changed after creation',
    },
    relatedTerms: ['tenant-name', 'create-tenant-action'],
    aliases: ['workspace identifier'],
  },
  {
  ...
  },
  {
    ...
    category: 'ui-fields',
    content: {
      brief: 'Choose an adapter from the registry to deploy to the target workspace.',
      detailed: 'Adapter picker:\n- Lists all registered adapters\n- Filter by: category, tier, name\n- Shows: adapter metadata, size, status\n- Validates compatibility with target workspace',
    },
  ...
  },
  {
    ...
    term: 'Target Workspace Field',
    category: 'ui-fields',
    content: {
      brief: 'The workspace environment where the adapter will be deployed and made available.',
      detailed: 'Workspace selector:\n- Lists active workspaces user has access to\n- Shows: workspace name, isolation level, status\n- Validates user has adapter:register permission\n- Links adapter to workspace registry',
    },
    relatedTerms: ['tenant-name', 'adapter-select-field'],
    aliases: ['workspace selector'],
  },
  ...
  // ===== Tenant Management Fields =====
  {
    ...
    category: 'ui-fields',
    content: {
      brief: 'Unique identifier for this workspace. Used for isolation and access control purposes.',
      detailed: 'Workspace identifier:\n- Globally unique across system\n- Used in: URLs, logs, audit trails\n- Format: lowercase alphanumeric + hyphens\n- Cannot be renamed (create new workspace instead)',
    },
  ...
  },
  {
    ...
    term: 'Workspace Description',
    category: 'ui-fields',
    content: {
      brief: 'Brief description of the workspace purpose and scope.',
      detailed: 'Workspace description:\n- Free-form text (max 500 chars)\n- Describe: purpose, team, project\n- Shown in workspace list and details\n- Editable after creation',
    },
  ...
  },
  {
    ...
    category: 'ui-fields',
    content: {
      brief: 'Unix User ID for filesystem isolation. Each workspace should have a unique UID.',
  ...
  },
  {
    ...
    content: {
      ...
      detailed: 'Unix GID:\n- Used for filesystem group permissions\n- Typically matches UID for single-workspace groups\n- Range: 1000-65535\n- Cannot be changed after creation',
    },
  ...
  },
  {
    ...
    category: 'ui-fields',
    content: {
      brief: 'Timestamp when this workspace was first created in the system.',
      detailed: 'Creation timestamp:\n- Immutable record of workspace creation\n- Displayed in local timezone\n- Used for age calculations and retention policies',
    },
  ...
  },
  {
    ...
    category: 'ui-fields',
    content: {
      brief: 'Number of users assigned to this workspace with active access.',
  ...
  {
    id: 'tenant-adapters',
    term: 'Workspace Adapters',
    category: 'ui-fields',
    content: {
      brief: 'Number of LoRA adapters assigned to this workspace for inference.',
      detailed: 'Adapter count:\n- Adapters registered to this workspace\n- Includes: all lifecycle states\n- Click to view adapter list\n- Used for capacity planning',
    },
  ...
  {
    id: 'tenant-policies',
    term: 'Workspace Policies',
    category: 'ui-fields',
    content: {
      brief: 'Number of policy packs applied to this workspace for governance.',
      detailed: 'Policy count:\n- Active policy packs enforced on workspace\n- Includes: egress, determinism, security policies\n- Click to view policy list\n- Used for compliance reporting',
    },
  ...
  },
  {
    ...
    term: 'Workspace Last Activity',
    category: 'ui-fields',
    content: {
      brief: 'Most recent activity timestamp for this workspace.',
      detailed: 'Last activity:\n- Updated on: inference, training, policy changes\n- Used to identify inactive workspaces\n- Displayed in local timezone\n- Informs archival decisions',
    },
  ...
  },
  {
    ...
    term: 'Create Workspace Button',
    category: 'ui-fields',
    content: {
      brief: 'Create a new workspace with isolated resources and policies. Requires workspace management permission.',
      detailed: 'Workspace creation:\n- Opens create workspace modal\n- Prompts for: name, description, isolation level, UID/GID\n- Validates uniqueness and permissions\n- Initializes workspace registry and namespace',
    },
    relatedTerms: ['create-tenant-action', 'tenant-name-field'],
    aliases: ['new workspace', 'add workspace'],
  },
  {
    id: 'create-tenant-action',
    term: 'Create Workspace Action',
    category: 'ui-fields',
    content: {
      brief: 'Finalize workspace creation with the specified configuration.',
      detailed: 'Workspace creation action:\n- Validates all required fields\n- Creates: namespace, registry, audit log\n- Assigns default policies\n- Redirects to workspace details page',
    },
    relatedTerms: ['create-tenant-button', 'tenant-name'],
  ...
  },
  {
    ...
    term: 'Save Workspace Changes',
    category: 'ui-fields',
    content: {
      brief: 'Save modifications to workspace configuration.',
  ...
  },
  {
    ...
    term: 'Archive Workspace Action',
    category: 'ui-fields',
    content: {
      brief: 'Archive this workspace. Resources will be suspended but can be restored by an administrator.',
      detailed: 'Archive workspace:\n- Sets status to Archived\n- Unloads all adapters\n- Blocks new inference requests\n- Retains data for compliance period\n- Requires confirmation + workspace management permission',
    },
  ...
  },
  {
    ...
    category: 'ui-fields',
    content: {
      brief: 'Assign selected policy packs to this workspace for governance enforcement.',
  ...
  },
  {
    ...
    category: 'ui-fields',
    content: {
      brief: 'Assign selected LoRA adapters to this workspace for inference.',
      detailed: 'Adapter assignment:\n- Multi-select adapters from registry\n- Validates workspace compatibility\n- Links adapters to workspace namespace\n- Requires adapter:register permission',
    },
  ...
  {
    id: 'import-tenants',
    term: 'Import Workspaces',
    category: 'ui-fields',
    content: {
      brief: 'Import workspace configurations from JSON or CSV file.',
      detailed: 'Workspace import:\n- Supports: JSON, CSV formats\n- Validates schema before import\n- Bulk create or update workspaces\n- Requires workspace management permission',
    },
  ...
  {
    id: 'export-tenants',
    term: 'Export Workspaces',
    category: 'ui-fields',
    content: {
      brief: 'Export workspace data to JSON or CSV format for backup or migration.',
      detailed: 'Workspace export:\n- Formats: JSON (full metadata), CSV (tabular)\n- Includes: configuration, policies, adapters\n- Respects RBAC (only accessible workspaces)\n- Used for: backup, migration, reporting',
    },
  ...
  },
  {
    ...
    category: 'ui-fields',
    content: {
      brief: 'Unique name for your trained adapter. Follows semantic naming: workspace/domain/purpose/revision format.',
  ...
  },
  {
    ...
    category: 'ui-fields',
    content: {
      brief: 'Resource overview: view workspaces, adapters, models, and policies with quick navigation links.',
      detailed: 'Resources panel:\n- Quick stats: workspace count, adapter count, policy count\n- Navigation: jump to detail pages\n- Summary: resource utilization\n- Used for: overview, quick access',
    },
