...
export const documentationIndex: DocumentationEntry[] = [
  ...
  },
  {
    ...
    path: 'ARCHITECTURE_INDEX.md',
    anchor: 'documentation-overview',
    category: 'getting-started',
  ...
  },
  {
    ...
    path: 'ARCHITECTURE_INDEX.md',
    anchor: 'path-1-visual-learner-recommended',
    category: 'guides',
  ...
  },
  {
    ...
    path: 'ARCHITECTURE_INDEX.md',
    anchor: 'path-2-code-first-developer',
    category: 'guides',
  ...
  },
  {
    ...
    path: 'ARCHITECTURE_INDEX.md',
    anchor: 'path-4-security-compliance',
    category: 'guides',
