...
import { resolveDatasetPrefill, StartTrainingForm } from '@/pages/Training/StartTrainingForm';
...
describe('StartTrainingForm dataset version handling', () => {
  ...
  const listDatasetVersionsMock = apiClient.listDatasetVersions as unknown as vi.Mock;
  ...
  it('shows inline error and blocks submission when dataset version is missing', async () => {
