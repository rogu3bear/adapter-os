...
Guidance for coding agents (Claude/ChatGPT/Copilot/etc.) working in this repository. Follow these guardrails to avoid hallucinations, preserve determinism, and respect tenant boundaries. Do **not** sign outputs or attribute work as “Claude”; just provide the content.
